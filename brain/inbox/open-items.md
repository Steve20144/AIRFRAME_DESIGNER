...
- **Hands-off drift acceptance**: ATLAS_09B fails the 1.5 m drift target because of a yaw-authority roll bias a
  pilot trims. Consider a position-hold stick option for the scripted pilot, or accept the criterion as OG-only.
